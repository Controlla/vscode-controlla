...
export function activate(context: vscode.ExtensionContext) {
	...
	let disposable = vscode.commands.registerCommand('vscode-controlla.helloWorld', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		vscode.window.showInformationMessage('Hello World from vscode-controlla!');
	});
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand(COMMAND_NEW_FEATURE, () => {
			// controlla.openDashboardWebsite();
			let url = 'https://controlla.com.mx/';
			vscode.env.openExternal(vscode.Uri.parse(url));
		}),
